...
/** An image to be used by the application  
    @type Image
*/
var s_back0 = new Image();
s_back0.src = "repeatBackground.png";

/** An image to be used by the application  
    @type Image
*/
var s_back1 = new Image();
s_back1.src = "fruitSalad.png";
...
/** An image to be used by the application  
    @type Image
*/
var s_gnu_right = new Image();
s_gnu_right.src = "gnu_right.png";

/** An image to be used by the application  
    @type Image
*/
var s_gnu_left = new Image();
s_gnu_left.src = "gnu_left.png";
...
function AnimatedUnStealthySamurai()
{
    ...
    */
	...
	this.setAnimation = function(image, frameCount, yAnimation, fps)
	{
		if  (frameCount <= 0) throw "framecount can not be <= 0";
		if (fps <= 0) throw "fps can not be <= 0"
...
function EnvironmentManager()
{
    ...
    */
    this.buildEnvironmentManager = function()
    {
		...
		this.background2 = new SamuraiMural().buildSamuraiMural(s_back1, 0, 0, 2, 600, 400, 0.75);        
        this.background = new SamuraiMural().buildSamuraiMural(s_back0, 0, 0, 1, 600, 400, 0.5);
...
function PlayableSamurai()
{
    ...
    */
    this.buildPlayableSamurai = function()
    {
		if (yAnim >= 0 && yAnim <= 8)
        {
			this.buildAnimatedUnStealthySamurai(s_gnu_right, 0, 0, 1, 3, 9, s_gnu_right.height / 9, 1);
		}
        return this;
    }
    ...
    */
    this.keyUp = function(event)
    {
		...
		{
            this.left = false;
			this.setAnimation(s_gnu_left, 3, 0, 9)
		}
		...
		{
            this.right = false;
			this.setAnimation(s_gnu_right, 3, 0, 9)
		}
	...
	/**
		Points the animation in the right direction
	*/
	this.updateAnimation = function()
	{
		if (this.right && this.left)
			...
			this.setAnimation(s_gnu_right, 3, 1, 9);
		else if (this.left)
			this.setAnimation(s_gnu_left, 3, 1, 9);
	}
    ...
    */
	this.update = function (/**Number*/ dt, /**CanvasRenderingContext2D*/context, /**Number*/ xScroll, /**Number*/ yScroll)
    {
        ...
        if (this.x > context.canvas.width - this.frameWidth + xScroll)
			s_SamuraiHQ.xScroll = this.x - (context.canvas.width - this.frameWidth);
        if (this.x < xScroll)
            s_SamuraiHQ.xScroll = this.x;
    }
}
...
// Should be split into it's own JS file called level.js *************************************************
function Level()
{
